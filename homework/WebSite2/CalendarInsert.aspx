...
<br />
<asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="load" Width="51px" />
    <asp:Label ID="LabelInserted" runat="server" ForeColor="#009933" Text="Succeed" Visible="False"></asp:Label>
    </asp:Content>
